class TMDBAPI {
    ...
    generateFallback() {
        return {
            movies: [
                {id:550,title:'Fight Club',overview:'Um homem insatisfeito com sua vida civil forma um clube de luta ilegal.',poster_path:'/pB8BM7pdSp6B6Ih7QI4S2t0POoT.jpg',backdrop_path:'/hZkgoQYus5dXo3H8T7Uef6DNknx.jpg',vote_average:8.4,release_date:'1999-10-15',genre_ids:[18]},
                {id:680,title:'Pulp Fiction',overview:'Historias entrelacadas de crime em Los Angeles.',poster_path:'/d5iIlFn5s0ImszYzBPb8JPIfbXD.jpg',backdrop_path:'/suaEOwWZPRob87nPBO0L1KPJtpd.jpg',vote_average:8.5,release_date:'1994-09-10',genre_ids:[53,80]},
                {id:238,title:'O Poderoso Chefao',overview:'A saga da familia mafiosa Corleone.',poster_path:'/3bhkrj58Vtu7enYsRolD1fZdja1.jpg',backdrop_path:'/tmU7GeKVybMWFButWEGl2M4GeiP.jpg',vote_average:8.7,release_date:'1972-03-14',genre_ids:[18,80]},
                {id:27205,title:'Inception',overview:'Um ladrao que rouba segredos via sonhos recebe uma tarefa impossivel.',poster_path:'/edv5CZvWj09upOsy2Y6IwDhK8bt.jpg',backdrop_path:'/s3TBrRGB1iav7gFOCNx3H31MoES.jpg',vote_average:8.4,release_date:'2010-07-15',genre_ids:[28,878]},
                {id:155,title:'O Dark Knight',overview:'Batman enfrenta o Coringa, um criminoso caotico.',poster_path:'/qJ2tW6WMUDux911BTUgMe1nDAt.jpg',backdrop_path:'/hkBaDkMWbLaf8B1lsWsKX7Ew3Xq.jpg',vote_average:9.0,release_date:'2008-07-16',genre_ids:[28,80]},
                {id:597,title:'Titanic',overview:'Uma historia de amor a bordo do navio fatidico.',poster_path:'/9xjZS2rlVxm8SFx8kPC3aIGCOYQ.jpg',backdrop_path:'/kHXEpyfl6zqn8a6YuLZzyYW7tBr.jpg',vote_average:7.9,release_date:'1997-11-18',genre_ids:[10749,18]},
                {id:299536,title:'Vingadores: Guerra Infinita',overview:'Os Vingadores enfrentam Thanos.',poster_path:'/7WsyChQLEftFiDhRDUMSjMcQRNB.jpg',backdrop_path:'/bOGkgRGdhrBYJSLpXaxhXVsttdV.jpg',vote_average:8.3,release_date:'2018-04-25',genre_ids:[28,12]},
                {id:24428,title:'Os Vingadores',overview:'Heroinis se unem para salvar a Terra.',poster_path:'/cezWGsk5R9t3I42LZLKcxaEAusP.jpg',backdrop_path:'/hQ4pYsIbP22TWXqX7sF0hJUvfoq.jpg',vote_average:8.0,release_date:'2012-04-25',genre_ids:[28,878]},
                {id:120,title:'O Senhor dos Aneis: O Retorno do Rei',overview:'A batalha final pela Terra Media.',poster_path:'/rCzpDGLbOoPwLjy6yGJdRBBBMwf.jpg',backdrop_path:'/pm0RiwNpS386bU3ReQ4a7XfEp1b.jpg',vote_average:8.5,release_date:'2003-12-01',genre_ids:[12,14]},
                {id:13,title:'Forrest Gump',overview:'A vida extraordinaria de um homem simples.',poster_path:'/arw2vcBveWOVZr6pxd9XTd1TdQa.jpg',backdrop_path:'/3h1JZGDhZ8nzxdgvkxha0qBgiyz.jpg',vote_average:8.6,release_date:'1994-06-23',genre_ids:[35,18]},
                {id:603,title:'Matrix',overview:'Um hacker descobre a realidade e uma guerra digital.',poster_path:'/f89U3ADr1oiB1s9GkdPOEpXUk5H.jpg',backdrop_path:'/fNG7i7RqMErkcqhohV2a6cV1Ehy.jpg',vote_average:8.7,release_date:'1999-03-30',genre_ids:[28,878]},
                {id:122,title:'O Senhor dos Aneis: As Duas Torres',overview:'A guerra continua na Terra Media.',poster_path:'/5VTN0pCa8LySDIq6Z62cI22ln1t.jpg',backdrop_path:'/5CGomQ5x8gLFiKzMPplau2MklhR.jpg',vote_average:8.5,release_date:'2002-12-18',genre_ids:[12,14]},
                {id:11,title:'Star Wars: Episodio IV',overview:'Um granjero se torna um heroi galactico.',poster_path:'/btbRB7BrD78Wq8U9kM1MbrXALIl.jpg',backdrop_path:'/4LrmnG8y1hFJz6E7GEl1LyZ6L2R.jpg',vote_average:8.2,release_date:'1977-05-25',genre_ids:[12,28]},
                {id:78,title:'Blade Runner',overview:'Um caçador de androides questiona sua humanidade.',poster_path:'/gajva2L0rPYkEWjzgFlBXCAVBE5.jpg',backdrop_path:'/zb6fStNCVVV0WvfWiGmwSvLkSqx.jpg',vote_average:8.1,release_date:'1982-06-25',genre_ids:[28,878]},
                {id:389,title:'O Padrinho II',overview:'A continuacao da saga Corleone.',poster_path:'/HEk9Q0r3Q9zR4JbqUHd8eEY0Yg.jpg',backdrop_path:'/sH2VFsfPJv283IU9YzMFf2gCxvL.jpg',vote_average:8.6,release_date:'1974-12-20',genre_ids:[18,80]}
            ],
            tv: [
